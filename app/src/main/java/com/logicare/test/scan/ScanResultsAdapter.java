...
class ScanResultsAdapter extends RecyclerView.Adapter<ScanResultsAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            line1=(TextView) itemView.findViewById(R.id.text1) ;
            line2=(TextView) itemView.findViewById(R.id.text2) ;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.line1.setText(String.format(Locale.getDefault(), "%s", bleDevice.getMacAddress()));
        holder.line2.setText(String.format(Locale.getDefault(), "RSSI: %d", rxBleScanResult.getRssi()));
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_scan_result, parent, false);
